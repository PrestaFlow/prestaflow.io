...
<body class="dark:bg-slate-900">
            ...
            <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
                ...
                <div class="flex items-center justify-between">
                    <a class="flex-none text-xl font-semibold dark:text-white" href="#"
                        aria-label="PrestaFlow">PrestaFlow</a>
                    <div class="sm:hidden">
                        <button type="button"
                ...
                <div id="navbar-collapse-with-animation"
                    ...
                    <div
                        ...
                        <a class="font-medium text-blue-600 sm:py-6 dark:text-blue-500" href="dark.html"
                            aria-current="page">&nbsp;</a>
                            ...
                            <div class="inline-flex rounded-lg shadow-sm">
                                <button type="button"
                                    ...
                                    <a href="{{ route('welcome.locale', ['locale' => 'en']) }}">
                                        <svg class="flex-shrink-0 w-4 h-4 rounded-full"
            ...
            <div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 mx-auto">
                ...
                <div class="grid justify-center md:grid-cols-2 md:justify-between md:items-center gap-2">
                    ...
                    <div class="flex items-center">
                        <a class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-lg font-medium text-white hover:bg-white/[.1] focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transition-all text-sm"
                            href="#">
        ...
        <div
            ...
            <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                ...
                <div class="mt-5 max-w-3xl text-center mx-auto">
                    <p class="text-lg text-gray-600 dark:text-gray-400"><span
                            class="font-bold bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">PrestaFlow</span>
    ...
    <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="text-center">
            ...
            <div class="mt-3">
                <p class="text-gray-500">Made with <span
                        class="m-1 inline-flex justify-center items-center w-[16px] h-[16px] rounded-full text-gray-500">
                        ...
                        href="https://twitter.com/PrestaEdit">PrestaEdit</a>.</p>
            </div>
            ...
            <div class="mt-3 space-x-2">
                ...
                <a class="inline-flex justify-center items-center w-10 h-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
                    href="https://twitter.com/PrestaFlow_io">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <a class="inline-flex justify-center items-center w-10 h-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
                    href="https://github.com/PrestaFlow">
